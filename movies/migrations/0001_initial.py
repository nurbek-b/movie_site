# Generated by Django 3.0.2 on 2020-03-03 06:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Описани')),
                ...
                ('country', models.CharField(max_length=18, verbose_name='Страна')),
                ('world_premier', models.DateField(default=datetime.date.today, verbose_name='Примьера в мире')),
                ('budget', models.PositiveIntegerField(default=0, help_text='Указать сумму в доллларах', verbose_name='Бюджет')),
                ...
                ('url', models.SlugField(max_length=160, unique=True)),
                ('draft', models.BooleanField(default=False, verbose_name='Чкрновик')),
